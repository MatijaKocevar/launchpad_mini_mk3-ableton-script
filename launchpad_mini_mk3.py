...
class launchpad_mini_mk3(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for launchpad_mini_mk3 in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in launchpad_mini_mk3._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in launchpad_mini_mk3._active_instances:    # Make sure you update the name
            launchpad_mini_mk3._active_instances.append(self)   # Make sure you update the name
            launchpad_mini_mk3._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in launchpad_mini_mk3._active_instances) and launchpad_mini_mk3._active_instances.remove(self):    # Make sure you update the name
    ...
    def _setup_mixer_control(self):
        ...
        is_momentary = True
        self._mixer = SpecialMixerComponent(64)
